...
<select name="date" required>
    ...
    for ($i = 0; $i < 5; $i++) {
        $future_date = date("Y-m-d", strtotime($current_date . " +$i days"));
        $formatted_date = date("F j, Y", strtotime($future_date)); 
        echo "<option value='$future_date'>$formatted_date</option>";
    }
    ?>
</select>
